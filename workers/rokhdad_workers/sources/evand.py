...
class EvandRawCollector:
    ...
    def _load_records(self) -> list[dict[str, Any]]:
        ...
        if not isinstance(records, list):
            raise ValueError("Evand raw response must be a list or an object with a data list.")
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    collector = EvandRawCollector(fixture_path=args.fixture, api_url=args.api_url)
