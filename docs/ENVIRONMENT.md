...
| `MONGODB_URI` | Yes | Yes | Backend/worker connection string, generated by `deploy/scripts/configure-mongodb.sh` |
...
| `REDIS_URL` | Yes | Yes | Backend/worker connection string, generated by `deploy/scripts/configure-redis.sh` |
