...
class OrganizerDashboardApiTest extends TestCase
{
    ...
    public function test_user_can_fetch_only_their_organizer_dashboard(): void
    {
        ...
        $this->actingAs($user, 'sanctum')
            ...
            ->assertJsonPath('data.summary.avg_revenue_per_registration', 1500000)
            ->assertJsonPath('data.analytics.registration_funnel.confirmed', 1)
            ->assertJsonPath('data.analytics.event_type_breakdown.0.event_type', 'in_person')
